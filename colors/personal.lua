...
hl("WinSeparator", { fg = palette.border, bg = "NONE" })
hl("SignColumn", { fg = palette.comment, bg = "NONE" })
hl("EndOfBuffer", { fg = palette.comment, bg = "NONE" })
hl("CursorLine", { bg = palette.raised })
hl("CursorLineNr", { fg = palette.amber, bg = palette.raised, bold = true })
hl("LineNr", { fg = palette.muted, bg = "NONE" })
hl("LineNrAbove", { fg = palette.comment, bg = "NONE" })
hl("LineNrBelow", { fg = palette.comment, bg = "NONE" })
